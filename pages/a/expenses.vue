  ...
  const fetchReimbursementRequests = async (month = null, year = null) => {
    try {
      ...
      if (month === null || (month === selectedMonth.value && year === selectedYear.value)) {
        ...
        const newClaims = validClaims.filter(claim => !existingIds.has(claim.id))
...
<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h1 class="text-xl font-bold">All Reimbursements</h1>
    </div>
                          ...
                          <Table class="bg-white">
                            ...
                            <TableBody>
                              ...
                              >
                                ...
                                <TableCell class="py-2">{{ formatDateTime(request.created_at) }}</TableCell>
                                <TableCell class="py-2">
