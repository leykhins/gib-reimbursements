...
const reimbursementRequests = ref<ReimbursementRequest[]>([])
const filteredRequests = ref<ReimbursementRequest[]>([])
...
const receiptSignedUrls = ref<Record<string, string>>({})
...
const toggleGroup = async (jobNumber: string) => {
...
const getJobTotal = (jobNumber: string) => {
...
const viewReceipt = async (receiptUrl: string, showDialog = true) => {
