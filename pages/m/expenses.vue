  ...
  if (actionableRequests.length === 0) {
    toast({
      ...
      description: requestId
        ? 'This request cannot be rejected because it is not admin verified.'
        : 'None of the selected requests can be rejected because they are not admin verified.',
      variant: 'destructive'
    })
    return
  }
  
  rejectingRequests.value = actionableRequests
  rejectingRequestId.value = actionableRequests[0]
